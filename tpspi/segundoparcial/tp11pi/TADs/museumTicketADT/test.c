...
main(void) {
    ...
    assert(addTicket(museum, 4, "John") == 2);
    assert(addTicket(museum, 4, "JOHN") == 3);
    assert(addTicket(museum, 4, "john") == 4);

    // Falla porque John ya cuenta con un ticket para visitar el museo el dÃ­a 4 del aÃ±o
    assert(addTicket(museum, 4, "John") == 5);
    ...
    assert(addTicket(museum, 4, "Paul") == 6);
    assert(addTicket(museum, 4, "Ariel") == 7);
